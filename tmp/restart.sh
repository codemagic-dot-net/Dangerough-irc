...
sudo -u $user -H sh -c "$installer -y install $centos_packages;"
fi
...
echo "#========================================================================"
sudo -u $user -H sh -c "cd ~;wget https://github.com/katmagic/Shallot/archive/master.zip;unzip master.zip -d Shallot;cd Shallot;./configure && make"
rm master.zip
echo "#========================================================================"
